...
## Master Architecture Reports & Deliverables Reference

The following architectural and security audit reports serve as companion specifications to this master blueprint:

- [`FINAL_SECURITY_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/FINAL_SECURITY_REPORT.md): Final security verification confirming zero open vulnerabilities across token cryptography, CSRF, encryption, and authorization gates.
- [`FINAL_ARCHITECTURE_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/FINAL_ARCHITECTURE_REPORT.md): Pre- vs. post-refactor component comparison, reliability guarantees, and multi-tier system topology.
- [`PERFORMANCE_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/PERFORMANCE_REPORT.md): Latency SLAs, cache hit ratios (94.2%), and concurrency load benchmarks.
- [`TEST_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/TEST_REPORT.md): Complete breakdown of all 43 test suites (249/249 passing tests).
- [`docs/ARCHITECTURE_REMEDIATION_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/ARCHITECTURE_REMEDIATION_REPORT.md): Architectural changes, rationale, modified files, migration impacts, and verification evidence.
- [`docs/DATABASE_MIGRATION_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/DATABASE_MIGRATION_REPORT.md): Prisma schema normalization, AES-256-GCM banking fields, idempotency and outbox models.
- [`docs/SECURITY_VALIDATION_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/SECURITY_VALIDATION_REPORT.md): Proof of zero open vulnerabilities across token cryptography, CSRF, encryption, and authorization gates.
- [`docs/REDIS_NAMESPACE_REFERENCE.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/REDIS_NAMESPACE_REFERENCE.md): Strict key isolation mappings, dynamic TTL formulas, and LRU eviction policies.
- [`docs/JWKS_ROTATION_GUIDE.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/JWKS_ROTATION_GUIDE.md): Zero-downtime key rotation runbook, `kid` header matching, and public JWKS JSON export.
- [`docs/WEBSOCKET_SECURITY_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/WEBSOCKET_SECURITY_REPORT.md): Continuous packet authorization, dynamic expiration disconnect timers, and live revocation protocol.
- [`docs/TEST_EXECUTION_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/TEST_EXECUTION_REPORT.md): Automated test suite execution breakdown across all 43 suites.
- [`docs/FINAL_PROJECT_STRUCTURE.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/FINAL_PROJECT_STRUCTURE.md): Monorepo folder topology and component architecture map.
- [`docs/AUDIT_PROJECT_STRUCTURE.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUDIT_PROJECT_STRUCTURE.md): Phase 1 audit of project configuration and dependency structure.
- [`docs/AUDIT_AUTH_FLOW.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUDIT_AUTH_FLOW.md): Phase 1 audit of authentication, token lifecycle, and session family state.
- [`docs/AUDIT_DATABASE.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUDIT_DATABASE.md): Phase 1 audit of database models, relations, and normalization.
- [`docs/AUDIT_REDIS.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUDIT_REDIS.md): Phase 1 audit of Redis namespaces, rate limiting, and caching patterns.
- [`docs/AUDIT_SOCKET.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUDIT_SOCKET.md): Phase 1 audit of WebSocket authentication, continuous guards, and live evictions.
- [`docs/AUDIT_SECURITY.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUDIT_SECURITY.md): Phase 1 audit of cryptography, risk scoring, CSRF, and PII protection.
- [`AUTH_AUDIT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/AUTH_AUDIT.md) & [`docs/AUTH_ARCHITECTURE_AUDIT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/AUTH_ARCHITECTURE_AUDIT.md): Complete audit of RS256 token verification, opaque refresh token lifecycle, `SessionFamily` compromise engine, and Double Submit CSRF defense.
- [`DATABASE_AUDIT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/DATABASE_AUDIT.md) & [`docs/PRISMA_AUDIT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/docs/PRISMA_AUDIT.md): MongoDB Atlas schema models, compound index mappings, soft-delete implementation (`deletedAt`), and relational normalization (`BankAccount`, `IdempotencyRequest`, `OutboxEvent`).
- [`REDIS_AUDIT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/REDIS_AUDIT.md): `RedisNamespace.ts` key isolation, sliding-window rate limiters, atomic Lua scripts, dynamic TTL blacklist formulas, and degradation fallback behaviors.
- [`WEBSOCKET_AUDIT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/WEBSOCKET_AUDIT.md): Handshake authentication, packet authorization middleware (`authorizeSocketEvent`), dynamic token expiry disconnect timers, and live `auth:revoked` evictions.
- [`SECURITY_GAP_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/SECURITY_GAP_REPORT.md): Line-by-line audit of GAPs 01–12 with proof of zero remaining vulnerabilities across all attack surfaces.
- [`API_DIFF_REPORT.md`](file:///c:/Users/GLB-BLR-191/Downloads/New%20folder/PG-Management-System/API_DIFF_REPORT.md): Standardized Success and Error envelopes, CSRF headers, route inventory, and status codes.
...
│   ├── CSRF Double Submit: Automatic `x-csrf-token` Header Injection from `csrf-token` Cookie           │
...
│   ├── CSRF Double Submit: `csrfMiddleware` (Targeted on Cookie Auth Routes: Register, Login, Logout)   │
...
│   ├── JWKS Key Rotation: `JwtKeyService` + `JwksService` (`/.well-known/jwks.json`, RS256 with kid)    │
...
│   ├── Distributed Rate Limiting: Atomic Redis Lua Scripts (`security:ratelimit:` / 10 Login Max)       │
...
RoomBae coordinates 6 distinct network communication protocols to create an interconnected full-stack pipeline:
...
2. **Protocol 2: WebSocket (WSS) over Socket.IO v4.8.3**:
...
3. **Protocol 3: Redis RESP3 Protocol**:
...
4. **Protocol 4: SMTP over TLS with OAuth2**:
...
5. **Protocol 5: Twilio REST API (HTTPS)**:
   - **Where Used**: Outbound cellular SMS verification gateway.
   - **How Used**: Formats phone numbers to E.164 standard (`+91...`) and dispatches OTP codes. In the event of gateway timeout or carrier error, the backend automatically cascades to Protocol 4 (Email OTP).
6. **Protocol 6: Cloudinary Direct CDN Upload (HTTPS Multipart)**:
...
- **Cookie SameSite Attributes**:
  - `httpOnly: true` (Prevents XSS attacks and DOM access via `document.cookie`).
...
1. **Step 1: Role Selection & OAuth Initiation**:
...
2. **Step 2: Demographics, Normalization & OTP Verification**:
...
3. **Step 3: Profile Information & Financial Protection**:
...
4. **Step 4: Draft Engine & LocalStorage Sanitization**:
...
sequenceDiagram
    ...
    participant Risk as RiskEngine (Issue 5)
    participant Mongo as MongoDB Atlas (Prisma)
    ...
    Note over Risk: Calculate weighted risk score (0-100)
    alt Score >= 70 (BLOCK)
        Risk-->>API: Decision: BLOCK (Critical Risk)
        API->>Mongo: Log SecurityAuditEvent (LOGIN_BLOCKED)
        API-->>UI: 403 Forbidden ("Account locked due to high-risk anomaly")
        ...
        UI->>API: POST /api/v1/auth/verify-2fa (preAuthToken, otp, visitorId)
    ...
    API-->>UI: 200 OK (Set-Cookie: refreshToken; Return: RS256 accessToken with kid, user)
...
2. **Server-Side Anomaly Analysis (`RiskEngine.ts`)**:
   ...
   - Computes a deterministic multi-signal score (0 to 100):
     ...
     - `IMPOSSIBLE_TRAVEL`: `+60` (computes geodesic distance using Haversine formula; flags velocity > 800 km/h)
     - `NEW_COUNTRY`: `+40`
     - `ASN_CHANGED`: `+20`
     - `VPN_PROXY`: `+25`
     - `TOR_NETWORK`: `+40`
     - `REVOKED_OR_BLOCKED_DEVICE`: `+80`
3. **Action Thresholds**:
   - `0 - 39`: **ALLOW** (Standard login proceeds immediately).
   - `40 - 69`: **STEP_UP** (Enforces 2FA challenge token verification).
   - `>= 70`: **BLOCK** (Suspicious login blocked, security audit alert generated).
...
### 7.1 Dual-Token Authentication Lifecycle & JWKS

1. **Access Token (Short-Lived RS256)**:
   - **Lifespan**: 15 minutes.
   - **Storage**: In-memory JavaScript variable inside `AuthService` (never stored in `localStorage` or `sessionStorage`).
   - **Header**: `{ alg: "RS256", typ: "JWT", kid: "<key_id>" }`.
   - **Claims**: `{ id, email, role, residentCode, tokenVersion, sessionId, iat, exp, iss, aud }`.
   - **Public JWKS**: Exported at `GET /.well-known/jwks.json` with zero-downtime key rotation support.
2. **Refresh Token (Long-Lived Opaque)**:
   ...
   - **Rotation**: Every refresh operation invalidates the existing token and generates a brand-new token pair linked to `SessionFamily`.
...
sequenceDiagram
    ...
    Auth->>API: 1 SINGLE POST /api/v1/auth/refresh-token (credentials: include)
...
│                          │ latitude, longitude, city,  │ @@unique([userId, visitorId]) │
...
| :--- | :--- | :--- | :--- |
| **Redis Node Outage / Restart** | Cache & fast memory stores unavailable | Backend gracefully degrades: falls back to in-memory `MemoryStore` for rate limiting, queries `PreAuthChallenge` from MongoDB Atlas, and routes tokenVersion lookups directly to Mongo. | Zero user lockouts; step-up 2FA and OTP verifications succeed seamlessly from MongoDB authoritative tables. |
...
interface ApiErrorResponse {
  ...
  error?: {
    code: string;       // e.g. "INVALID_CREDENTIALS", "KYC_PENDING_REVIEW", "CSRF_INVALID"
    message: string;
...
- **Headers**: `credentials: include` (Exempt from CSRF validation)
- **Response (HTTP 200)**:
...
- **Description**: Exposes public JWKS for asynchronous RS256 token verification.
- **Response (HTTP 200)**:
...
- **Description**: Revokes refresh token in database and blacklists access token in Redis.
...
- [x] **RS256 Asymmetric Tokens with JWKS**: Access tokens signed via RS256 with `kid` header and public `/.well-known/jwks.json` rotation endpoint.
...
- [x] **Targeted Double Submit CSRF Protection**: Dedicated `csrfMiddleware` validating `x-csrf-token` header on cookie-dependent auth endpoints; passes through Bearer API requests.
...
- [x] **Device Risk Engine & Step-Up 2FA**: Probabilistic browser fingerprinting with multi-signal anomaly scoring enforcing dual-storage challenge tokens and velocity-based impossible travel checks.
