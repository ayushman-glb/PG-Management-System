...
export class PropertyService implements IPropertyService {
  ...
  /**
   * Geo-Spatial Search for PG properties with location distance calculation & filters
   */
  async searchPublicProperties(query: ISearchPropertiesQuery) {
    ...
    // Distance calculation & dynamic filtering
  ...
  /**
   * Get single PG property details with room grid & availability
   */
  ...
  /**
   * Owner Summary Metrics (MRR, Occupancy Rate %, Active Complaints, Pending Dues)
   */
