...
const testimonials = [
  {
    ...
    avatar: "PS",
    rating: 5,
    text: "PG Manager transformed how I run my three properties. Rent collection is fully automated now. I save 15+ hours every month.",
    location: "Bengaluru",
  },
  {
    name: "Arjun Mehta",
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center gap-4 md:gap-8">
          ...
          <div className="hidden md:flex items-center gap-3 ml-auto">
            ...
            <button
              ...
              className="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors px-4 py-2"
            >
              Sign in
            </button>
            <button
              onClick={() => navigate("auth")}
              className="text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 transition-colors px-5 py-2.5 rounded-xl shadow-sm shadow-blue-200"
            >
              Start Free Trial
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed mb-10">
              The complete PG Management platform for property owners. Manage
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                onClick={() => navigate("auth")}
                className="flex items-center gap-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-7 py-3.5 rounded-2xl shadow-lg shadow-blue-200 transition-all hover:scale-105 text-base"
              >
                Start Free Trial
              ...
              <button
                ...
                className="flex items-center gap-2.5 bg-white border border-slate-200 hover:border-slate-300 text-slate-700 font-semibold px-7 py-3.5 rounded-2xl shadow-sm transition-all hover:scale-105 text-base"
              >
              ...
              <div className="bg-white p-6 grid grid-cols-12 gap-4">
                ...
                <div className="col-span-2 hidden md:block">
                  <div className="space-y-1">
                    {[
                      ...
                      <div
                        key={i}
                        className={`flex items-center gap-2 px-2 py-2 rounded-lg text-xs ${i === 0 ? "bg-blue-600 text-white" : "text-slate-400"}`}
                      >
                ...
                <div className="col-span-12 md:col-span-10 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="flex items-end gap-1.5 h-20">
                        {[60, 75, 55, 80, 70, 90, 85, 95, 88, 92, 78, 100].map(
                          (h, i) => (
                            <div
                              key={i}
                              className={`flex-1 rounded-t-md ${i === 11 ? "bg-blue-600" : "bg-blue-200"}`}
                              style={{ height: `${h}%` }}
                            />
                          ),
                        )}
                    ...
                    <div className="bg-gradient-to-br from-blue-600 to-violet-600 rounded-xl p-3 text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {features.map((feature, i) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="feature-card group bg-slate-50 hover:bg-white border border-slate-100 hover:border-slate-200 rounded-2xl p-5 card-hover cursor-default"
                >
                  <div
                    className={`feature-icon w-10 h-10 rounded-xl bg-gradient-to-br ${bg} flex items-center justify-center mb-4 shadow-sm`}
                  >
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {[
              ...
              return (
                <div
                  ...
                  className={`bg-gradient-to-br ${item.color} rounded-2xl p-6 cursor-pointer hover:scale-[1.02] transition-transform shadow-lg`}
                >
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div
              ...
              className="bg-white border border-slate-100 rounded-2xl p-6 cursor-pointer hover:border-blue-200 hover:shadow-md transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <button
                onClick={() => navigate("auth")}
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl shadow-sm shadow-blue-200 transition-all"
              >
                Get Started Free
                <ArrowRight className="w-4 h-4" />
              </button>
                ...
                {whyUs.map((item, i) => {
                  ...
                  return (
                    <div key={item.title} className="flex gap-4 pb-8 relative">
                      ...
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-violet-600 flex items-center justify-center flex-shrink-0 shadow-md shadow-blue-200 z-10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 card-hover">
              ...
              <button
                onClick={() => navigate("auth")}
                className="w-full py-3 rounded-xl border-2 border-blue-600 text-blue-600 font-semibold text-sm hover:bg-blue-50 transition-colors"
              >
                Start Free Trial
              </button>
            </div>
            ...
            <div className="pricing-card-popular rounded-2xl p-8 shadow-2xl shadow-blue-200 -translate-y-4 scale-[1.02]">
              ...
              <button
                onClick={() => navigate("auth")}
                className="relative w-full py-3 rounded-xl bg-white text-blue-600 font-semibold text-sm hover:bg-white/90 transition-colors shadow-md"
              >
                Start Free Trial
              </button>
            </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-blue-600 via-violet-600 to-blue-700 rounded-3xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  onClick={() => navigate("auth")}
                  className="flex items-center gap-2 bg-white text-blue-600 font-bold px-8 py-3.5 rounded-2xl shadow-lg hover:scale-105 transition-all text-base"
                >
                  Start Free Trial
                  <ArrowRight className="w-4 h-4" />
                </button>
      ...
      <footer className="border-t border-slate-100 bg-white px-6 py-12">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-3">
                {[Globe, Link, ExternalLink, AtSign].map((Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="w-8 h-8 bg-slate-100 hover:bg-blue-100 rounded-lg flex items-center justify-center text-slate-500 hover:text-blue-600 transition-colors"
                  >
                    <Icon className="w-3.5 h-3.5" />
                  </a>
                ))}
          ...
          <div className="border-t border-slate-100 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-slate-400">
              © 2025 PG Manager. All rights reserved.
            </p>
        ...
        >
          ...
          >
            ...
            <div className="grid gap-6 bg-slate-50 p-6 md:grid-cols-[1.2fr_0.8fr]">
              <div className="relative aspect-video overflow-hidden rounded-2xl bg-gradient-to-br from-blue-700 via-violet-700 to-slate-900 p-6 text-white shadow-lg">
                <div
              ...
              <div className="flex flex-col justify-center">
                ...
                <button
                  ...
                  className="mt-6 flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-bold text-white transition-colors hover:bg-blue-700"
                >
